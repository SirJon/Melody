...
<!-- MAIN -->
<main class="page__main" data-page="delivery">
  <!-- delivery section-->
  <section class="delivery">
    <h2 class="delivery__title title--page" data-lang="deliveryPayment">Доставка и оплата</h2>
    <p class="delivery__paragraph">
      <span class="delivery__span">
        <span data-lang="deliveryBlock1Start">После отправления заявки</span>
        <span class="weight--600" data-lang="deliveryBlock1Body">наш менеджер свяжется с вами в течение 1 часа</span>
        <span data-lang="deliveryBlock1End">для уточнения деталей.</span>
      </span>
      <span class="delivery__span">
        <span class="weight--600" data-lang="deliveryBlock2Start">Мы доставляем</span>
        <span data-lang="deliveryBlock2End">
          нашу продукцию в любой город России, а также в страны ближнего и
          дальнего зарубежья собственным автопарком или с помощью транспортных компаний: КС «СДЭК», 
          ТК «Деловые Линии», ООО «ПЭК». Мы поможем вам подобрать оптимальный способ доставки.
        </span>
      </span>
      <span class="delivery__span">
        <span class="weight--600" data-lang="deliveryBlock3Start">Отгрузка</span>
        <span data-lang="deliveryBlock3End">производится после 100% предоплаты в течение 1-5 рабочих дней.</span>
      </span>
      <span class="delivery__span">
        <span class="weight--600" data-lang="deliveryBlock4Start">Для покупателей из других стран</span>
        <span data-lang="deliveryBlock4End">доступна оплата через международный банковский перевод по системе SWIFT.</span>
      </span>
    </p>
  </section>
